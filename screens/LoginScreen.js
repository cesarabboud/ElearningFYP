...
const LoginScreen = ({ navigation }) => {
  ...
  const myFct = async () => {
    ...
    await fetch("http://192.168.0.105:8000/api/login", {
      method: "POST",
      headers: {
    ...
    >
      <KeyboardAvoidingView>
        ...
        <Text style={{color:"#ba1629"}}>Password is required</Text>
            ...
            {/* <View style={{borderWidth:1,justifyContent:'center',alignItems:'center',borderRadius:'50%'}}> 
            <Checkbox
            ...
            <TouchableOpacity style={styles.loginbtn} onPress={myFct}>
              <Text
                style={{
                  textAlign: "center",
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              >
                <Text style={{ color: "#03ba55" }}>Sign Up</Text>
              </TouchableOpacity>
            </View>

            {/* <Text> Flag :{rememberMe ? 'checked' : 'unchecked'}</Text> */}
