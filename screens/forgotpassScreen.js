...
const ForgotScreen = ({navigation}) => {
  ...
  const changePass = async () => {
    const msgs = {}
    if(currentPassword === ''){
      msgs.currpass="Current Password is required"
    }
    if(newPassword === ''){
      msgs.newpass="New Password is required"
    }
    if(confirmPassword === ''){
      msgs.confirmpass="Confirm Password is required"
    }
    ...
    if(Object.keys(validationMessages).length === 0){
      ...
      if(token !== null){
        try{
          const resp = await fetch('http://192.168.0.107:8000/api/changePassword',{
            method:"POST",
            headers:{
          ...
          setValidationCheck(resData.errorMessage ? `Password should be at least 8 characters long, include a number, a capital letter and a special character!` : "")
          setTimeout(()=>{
            if(resData.msg === 'ok'){
              navigation.goBack()
            }
      ...
      <KeyboardAvoidingView>
        <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
          <View style={styles.content}>
            <SvgXml xml={svgLogo} height={90} width={250} />
            <View style={{gap:2}}>
              <TextInput
                ...
                theme={{
                  colors: {
                    ...
                    //working
                    outline: validationMessages.currpass ? "#ba1629" : "grey",
                  },
                }}
                ...
                //textColor="red"
              />
              <Text style={{fontSize:12,color:'#ba1629'}}>{" "}{validationMessages.currpass}
              {msg==='password is incorrect' ? "Password is incorrect" : null}
              </Text>
              <TextInput
                label="New Password"
                mode="outlined"
                ...
                theme={{
                  colors: {
                    ...
                    onSurfaceVariant: "grey",
                    //working
                    outline: validationMessages.newpass ? "#ba1629" : "grey",
                  },
                }}
                value={newPassword}
                ...
                //textColor="red"
              />
              <Text style={{fontSize:12,color:'#ba1629'}}>{" "}{validationMessages.newpass}</Text>
              <TextInput
                ...
                theme={{
                  colors: {
                    ...
                    onSurfaceVariant: "grey",
                    //working
                    outline: validationMessages.confirmpass ? "#ba1629" : "grey",
                  },
                }}
                ...
                //textColor="red"
              />
              <Text style={{fontSize:12,color:'#ba1629',width:validationCheck !== '' ? 250 : null}}>{validationMessages.confirmpass}
              {msg==='passwords do not match' ? msg : null}
              {validationCheck !== "" ? 
              validationCheck : null}
              </Text>
            </View>
            <TouchableOpacity 
            style={styles.sendinstructions}
            onPress={changePass}
            >
                <Text
                  style={{
