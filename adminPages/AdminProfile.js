...
import PricesBarChart from './BarChart/PricesBarChart'
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Image
          ...
          resizeMode="cover"
          style={{ height: 60, width: 60, borderRadius: 100,backgroundColor:'#fff' }}
        />
...
const styles = StyleSheet.create({
  ...
  fixedView: {
    ...
    zIndex: 1, // Ensure the fixed view is above other content
    padding:10,
    borderBottomWidth:1,
